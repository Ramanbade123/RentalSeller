    ...
    <div className="min-h-screen bg-gray-50 flex font-sans">
      ...
      <div className="hidden lg:block relative w-1/2 bg-gray-700">
        ...
        <img
          ...
          alt="Electronics equipment for rent"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 flex flex-col justify-center p-12 text-white">
          <h1 className="text-4xl font-bold mb-4">Rent From Rentour</h1>
          <p className="text-xl mb-8">
            Access high-end tech without the commitment. Perfect for students,
            travelers, creators, and professionals.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 lg:hidden">
            <h1 className="text-3xl font-bold text-gray-700">Rentour</h1>
            <p className="mt-2 text-gray-600">
              Premium electronics rental platform
            </p>
          </div>
                ...
                <div>
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <path d="M12.545 10.239v3.821h5.445c-0.712 2.315-2.647 3.972-5.445 3.972-3.332 0-6.033-2.701-6.033-6.032s2.701-6.032 6.033-6.032c1.498 0 2.866 0.549 3.921 1.453l2.814-2.814 0.008-0.008c-1.811-1.697-4.252-2.722-6.943-2.722-5.622 0-10.18 4.558-10.18 10.18s4.558 10.18 10.18 10.18c8.396 0 10.18-7.962 10.18-10.18 0-0.61-0.042-1.229-0.126-1.839h-10.054z" />
                    </svg>
                  </a>
                </div>
              </div>
