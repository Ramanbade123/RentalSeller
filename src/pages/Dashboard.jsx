    ...
    <div className="flex h-screen bg-gray-50 font-sans antialiased">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            onClick={() => {console.log("ClickTo"); navigate("/finalize")}}
            className={`flex citems-center w-full px-4 py-3 text-sm bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-colors ${
