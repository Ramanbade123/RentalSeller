        ...
        <div className="flex flex-col items-center h-fit py-14">
            ...
            <div className="flex flex-wrap justify-center gap-2 px-4">
                {imageCards.map((card, index) => (
                    <div
                        key={index}
                        className="group relative w-[250px] h-[320px] rounded-xl overflow-hidden shadow-lg transition-all duration-[750ms] ease-[cubic-bezier(0.25, 1, 0.5, 1)] hover:w-[350px] hover:h-[360px] hover:z-10"
                        onMouseEnter={() => handleMouseEnter(card.description, index)}
                        onMouseLeave={handleMouseLeave}
                    >
                        <img
                            src={card.imgsrc}
                            alt={card.title}
                            className="w-full h-full object-cover transition-all !duration-[750ms] ease-[cubic-bezier(0.25, 1, 0.5, 1)] group-hover:scale-[1.1]"
                        />
